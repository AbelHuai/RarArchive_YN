...
@interface YNUnrar4iOS(PrivateMethods)
...
@implementation YNUnrar4iOS

@synthesize filename, password;

int CALLBACK YNCallbackProc(UINT msg, long UserData, long P1, long P2) {
	UInt8 **buffer;
...
-(NSData *) extractStream:(NSString *)aFile {
	...
	RARSetCallback(_rarFile, YNCallbackProc, (long) &callBackBuffer);
